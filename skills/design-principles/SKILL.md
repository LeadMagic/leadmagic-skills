...
description: Foundational design principles and visual design systems reference. Use when creating UI designs, choosing typography/spacing/color values, designing components, or needing UX heuristics. Triggers on "design system", "spacing scale", "typography scale", "color palette", "UX principles", "Nielsen heuristics".
license: MIT
metadata:
  author: leadmagic
  version: "1.0.0"
...
Curated best practices from world-class designers and design systems. Reference these principles when generating UI designs.
